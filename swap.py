...
with inputFile.open() as original:
	with outputFile.open('w') as flipped:
		...
		# The 'layers' attribute is an array of arrays, where
		# each array is a row of keys on the keyboard.
		# For each row, split the row of keys in half,
		# then swap the halves around.
